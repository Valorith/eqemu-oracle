...
class SkillGuidanceTest(unittest.TestCase):
    def test_umbrella_skill_describes_remote_profile_discovery_and_undo(self) -> None:
        ...
        self.assertIn("run_eqemu_server_ftp_upload_session", text)
        ...
        self.assertIn("write_audit", text)
        self.assertIn("before/after SHA-256", text)
        self.assertIn("final read-only mode", text)
        self.assertIn("undo availability", text)
